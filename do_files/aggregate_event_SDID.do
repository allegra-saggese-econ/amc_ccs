...
***************************************************************************
	...
	noisily di "`var' SDID - `year' $S_TIME"
		preserve
		/* ---- is this a 'not-yet-treated' method? no
...
//	egen d_o = rowmean(d_o*)						// point estimate in event study plot
	...
	* Generate plot
	tw rarea UCI LCI eventyear, color(gray%30) || scatter d_o eventyear, color(black) m(d) xtitle("") xlab(`start'(1)`end', angle(45)) legend(order(2 "Point Estimate" 1 "95% CI") pos(12) col(2)) xline(-1, lc(black) lp(solid)) yline(0, lc(red) lp(shortdash))
	
	graph export "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated.pdf", replace
	
	save "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated_result.dta", replace
}
...
use "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated_result.dta", clear
		set scheme lean2 
				* Define first and last treatment years for the industry
		local fstyr = 2007
		local lastyr = 2020
		...
		* Define eventyear as a column vector, (-18,...,21)'
		...
		local end = 2020 - `fstyr'
	* Generate plot
	tw rarea UCI LCI eventyear, color(gray%30) || scatter d_o eventyear, color(black) m(d) xtitle("") xlab(`start'(1)`end', angle(45)) legend(order(2 "Point Estimate" 1 "95% CI") pos(12) col(2)) xline(-1, lc(black) lp(solid)) yline(0, lc(red) lp(shortdash))  note("Any subsidy")
	
	graph export "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated.png", replace
}
...
use "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated_result_t_d.dta", clear
		...
		* Define eventyear as a column vector, (-18,...,21)'
		...
		local end = 2020 - `fstyr'
	* Generate plot
	tw rarea UCI LCI eventyear, color(gray%30) || scatter d_o eventyear, color(black) m(d) xtitle("") xlab(`start'(1)`end', angle(45)) legend(order(2 "Point Estimate" 1 "95% CI") pos(12) col(2)) xline(-1, lc(black) lp(solid)) yline(0, lc(red) lp(shortdash)) note("Demand subsidy")
	
	graph export "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated_t_d.png", replace
}
...
use "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated_result_t_innov.dta", clear
		...
		* Define eventyear as a column vector, (-18,...,21)'
		...
		local end = 2020 - `fstyr'
	* Generate plot
	tw rarea UCI LCI eventyear, color(gray%30) || scatter d_o eventyear, color(black) m(d) xtitle("") xlab(`start'(1)`end', angle(45)) legend(order(2 "Point Estimate" 1 "95% CI") pos(12) col(2)) xline(-1, lc(black) lp(solid)) yline(0, lc(red) lp(shortdash))  note("Innovation subsidy")
	
	graph export "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated_t_innov.png", replace
}
...
use "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated_result_t_s.dta", clear
		...
		* Define eventyear as a column vector, (-18,...,21)'
		...
		local end = 2020 - `fstyr'
	* Generate plot
	tw rarea UCI LCI eventyear, color(gray%30) || scatter d_o eventyear, color(black) m(d) xtitle("") xlab(`start'(1)`end', angle(45)) legend(order(2 "Point Estimate" 1 "95% CI") pos(12) col(2)) xline(-1, lc(black) lp(solid)) yline(0, lc(red) lp(shortdash)) note("Supply subsidy")
	
	graph export "$projdir/output/Regressions/temp/figure/event_sdid//`var'_aggregated_t_s.png", replace
}
